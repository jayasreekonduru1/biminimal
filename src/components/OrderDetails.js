...
//       <h3>Order Details</h3>
//       {order ? (
//         <div className="d-flex justify-content-center gap-3 order-summary w-100">
//           {/* <div className="order-item d-flex justify-content-between  border p-2 mb-2">
//             <div className="item-details">
//               <h4>Name: {order.name}</h4>
//               <p>Email: {order.email}</p>
...
//           <div className="d-flex justify-content-end w-100 mt-3">
//             <button className="btn btn-dark" onClick={handleDownloadInvoice}>Download Invoice</button>
//           </div>
//           </div>
//         </div>
//       ) : (
